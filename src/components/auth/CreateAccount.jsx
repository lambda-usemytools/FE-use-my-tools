				...
				<BottomContent>
					<Form onSubmit={handleSubmit}>
						...
						<CreateAccountInputGroup>
							...
							<LargerSubmitButton type='submit' disabled={submitting || pristine}>
								Create Account
							</LargerSubmitButton>
						</CreateAccountInputGroup>
					</Form>
					...
					<TestamonialContainer>
						...
						<TestamonialText>
							I was tired of always loaning tools and not remembering who I lent them to. With Use My Tools I know where
							all of my tools are all the time, and I'm even making money by renting out the tools I have.
						</TestamonialText>
